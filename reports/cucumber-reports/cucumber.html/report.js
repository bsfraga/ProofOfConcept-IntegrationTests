$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("file:src/test/java/features/FailedDataDrivenFeatureExample.feature");
formatter.feature({
...
formatter.uri("file:src/test/java/features/FailedSimpleFeatureExample.feature");
formatter.feature({
  "name": "Validar dados de serviço HearthStone com dados inválidos",
...
formatter.uri("file:src/test/java/features/SuccessDataDrivenFeatureExample.feature");
formatter.feature({
...
formatter.uri("file:src/test/java/features/SuccessSimpleFeatureExample.feature");
formatter.feature({
  "name": "Validar dados de serviço HearthStone",
  "description": "  Como um usuário fã de hearthstone\n  Quero Consumir endpoints do serviço de Hearthstone\n  Para obter e validar informações sobre as minhas cartas favoritas",
  "keyword": "Funcionalidade"
